        ...
        {loading ? <p className={TEXT_COLORS.muted}>Đang tải dữ liệu...</p> : !data ? <p className={TEXT_COLORS.muted}>Không thể tải dữ liệu. Kiểm tra backend.</p> : (
          <>
            <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2 transition-all duration-500">
              <ChartCard title="E1: Số lượng và tỷ lệ video viral theo danh mục" description="Click cột để lọc theo danh mục">
              ...
              <ChartCard title="E2: Động lượng viral theo kênh" description="Click điểm để xem chi tiết kênh trong console">
                <BoxPlotly
